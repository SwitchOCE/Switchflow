...
const staticFiles = Object.fromEntries(['index.html','app.js','styles.css','documents.js','documents.css','milestones.js','milestones.css','tasks.js','tasks-model.js','tasks-view-state.js','tasks-editor.js','tasks.css','initiative-tasks.js','knowledge.js','knowledge-model.js','knowledge.css','insights.js','insights.css','workspace-client.js','workspace-search.js','skills.js','skills.css','overview-model.js','ui-date.js'].map(file => [`/${file}`, [file, file.endsWith('.html') ? 'text/html' : file.endsWith('.css') ? 'text/css' : 'text/javascript']]));
